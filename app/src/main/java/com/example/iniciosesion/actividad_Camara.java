...
public class actividad_Camara extends AppCompatActivity {
    ...
    private void aceptarimg(){
        ...
        aceptarimg.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                startActivity(new Intent(actividad_Camara.this, registro.class));
            }
        });
    }
    ...
    private void abrirCamara(){
        ...
        if(intent.resolveActivity(getPackageManager()) != null) {
            ...
            if(imagenArchivo != null){
                Uri fotoUri = FileProvider.getUriForFile(this, "com.example.iniciosesion.fileprovider", imagenArchivo);
